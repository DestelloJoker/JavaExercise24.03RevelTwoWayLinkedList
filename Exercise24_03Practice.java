/*Program Name: Exercise24_03Practice.java
* called Exercise24_03Practice since I did 2 versions of this code one that removes the
* hard coded element 2 addition and 3 removal and then this one that follows the purpose
 * Authors: Austin P
...
public class Exercise24_03Practice {
    public static void main(String[] args) {
        new Exercise24_03Practice();
    }

    public Exercise24_03Practice() {
        ...
        list.add(v[4]);
        list.add(0, v[0]);
        list.add(2, 10.55); // Add 10.55 at index 2
